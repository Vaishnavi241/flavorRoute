    ...
    <div className='footer' id='footer'>
        <div className="footer-content">
            <div className="footer-content-left">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae quibusdam odit officia 
                    beatae. Totam nulla laudantium nisi officiis asperiores minima.
                    </p>
